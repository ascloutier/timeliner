            ...
            if ($(settings.timelineContainer).data('started')) {
                ...
                $(settings.timelineContainer).on("click",settings.timelineSectionMarker,function()
                {
                    ...
                    if(numEvents > numOpen )
                    {
                        ...
                        closeEvent($(this).parents(settings.timelineSection).find(settings.timelineTriggerContainer + " " + settings.timelineTriggerAnchor),$(this).parents(settings.timelineSection).find(settings.timelineEXContent));
